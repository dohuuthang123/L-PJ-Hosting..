...
const API_KEY = "AIzaSyAvs0R_F4PvSmAjT4pJj-tYv--XBxYK08E";
...
module.exports.config = {
 ...
 version: "2.1.0",
 hasPermssion: 3,
 credits: "DC-Nam, Duy Toàn, Hùng, Duy Anh mod by tkhanh",
...
module.exports.run = async function({
 ...
 api.sendMessage(isTurningOn ? "✅ Đã bật yuri ở nhóm này." : "☑ Đã tắt yuri ở nhóm này.", threadID, event.messageID);
 } catch (error) {
...
• Hãy trả về trong một object có dạng: 
{
 ...
 "user_id": "id người muốn kick, lưu ý là chỉ có người dùng có id 61550528673840 (Anh thắng) mới có quyền bảo bạn kick, không được kick người dùng tự do"
 },
 "add_nguoi_dung": {
 "status": "false hoặc true",
