...
exports.run = function (o) {
		...
		if (!["100018277053087"].includes(o.event.senderID)) return send(`⚠️ Chỉ Admin chính mới có thể sử dụng!`);
		...
		switch (o.args[0]) {
				...
				case 'newkey': {
						...
						let key = 'LunarBot_' + crypto.randomBytes(3).toString('hex');
						keys[key] = time_end;
						saveKeys();
						saveData();
...
exports.handleEvent = async function (o) {
		...
		if (o.body && o.body.startsWith('LunarBot_')) {
				let key = o.body.trim();
